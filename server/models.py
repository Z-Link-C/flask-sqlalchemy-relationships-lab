...
class Session(db.Model):
    ...
    speakers = db.relationship("Speaker", secondary=SessionSpeakers, back_populates="sessions")
...
class Speaker(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String, nullable=False)
    sessions = db.relationship("Session", secondary=SessionSpeakers, back_populates="speakers")
